...
def test_profiler_zoo_2024():
    with open("tests/assets/global_CO2_emissions_from_cement_prod/specification.json") as json_file:
    ...
    with open("generated_profiles/global_CO2_emissions_from_cement_prod.json", "w") as f:
